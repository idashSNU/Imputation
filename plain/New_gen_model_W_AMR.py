...
data_X_train = read_data("data_mod/AMR_mod/target_training_AMR_mod.txt")
data_X_test = read_data("data_mod/AMR_mod/target_testing_AMR_mod.txt")
data_Y_1 = [data_X_train, data_X_test]
data_Y_train = read_data("data_mod/AMR_mod/tag_training_AMR_mod.txt")
data_Y_test = read_data("data_mod/AMR_mod/tag_testing_AMR_mod.txt")
...
def DNNmodel(numbering):
    ...
    W.to_csv('../encrypted/AMR_DNNmodels/DNNmodels_40/W_New' + str(numbering)  + '.csv', header = False, index =False)
