...
data_X_train = read_data("data_mod/EUR_mod/target_training_EUR_mod.txt")
data_X_test = read_data("data_mod/EUR_mod/target_testing_EUR_mod.txt")
data_Y_1 = [data_X_train, data_X_test]
data_Y_train = read_data("data_mod/EUR_mod/tag_training_EUR_mod.txt")
data_Y_test = read_data("data_mod/EUR_mod/tag_testing_EUR_mod.txt")
...
def DNNmodel(numbering):
    ...
    W.to_csv('../encrypted/EUR_DNNmodels/DNNmodels_40/W_New' + str(numbering)  + '.csv', header = False, index =False)
